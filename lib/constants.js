...
module.exports = Object.freeze({
  userAgent: `TwoCaptcha - JavaScript/Node.js package v${require('../package.json').version}`,
  ...
  errors: {
    ...
    'MAX_USER_TURN': "You made more than 60 requests to in.php within 3 seconds. Set at least 100 ms timeout between requests to in.php. You are blocked for 10 seconds.",
